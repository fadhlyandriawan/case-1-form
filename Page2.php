...
$hasil_format = number_format($hasil, 2, ',', '.');
$hasil_format1 = number_format($M0, 2, ',', '.');
?>
...
<div class="container" style="margin-bottom: 100px;">
    <div class="row">
        <div class="col-sm-12">
            ...
            <h1>Hasil Perhitungan dari Modal Akhir tersebut</h1>
            <?php
            if ($hasil !== "") {
                echo "<h2> Adalah <strong>Rp$hasil_format</strong></h2>";
            } else {
                echo "<p>Belum ada hasil perhitungan yang tersedia.</p>";
            }

            echo "<p>Modal Awal (M0): <strong>Rp$hasil_format1</strong></p>";
